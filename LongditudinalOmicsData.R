...
rownames(alpha0) <- paste0("obs",1:n)
colnames(alpha0) <- paste0("otu",1:J)
rownames(alpha0_update[,,n_sim]) <- paste0("obs",1:n)
colnames(alpha0_update[,,n_sim]) <- paste0("otu",1:J)
...
rownames(alpha0_grp) <- paste0("row",1:n)
colnames(alpha0_grp) <- paste0("column",1:J)
rownames(alpha0_grp_update[,,n_sim]) <- paste0("row",1:n)
colnames(alpha0_grp_update[,,n_sim]) <- paste0("column",1:J)
...
rownames(mu_jl) <- paste0("cluster",1:L)
colnames(mu_jl) <- paste0("otu",1:J)
rownames(mu_jl_update[,,n_sim]) <- paste0("cluster",1:L)
colnames(mu_jl_update[,,n_sim]) <- paste0("otu",1:J)
...
rownames(estimated_f) <- paste0("row",1:J)
colnames(estimated_f) <- paste0("column",1:n)

rownames(true_f) <- paste0("row",1:J)
colnames(true_f) <- paste0("column",1:n)
...
rownames(true_f) <- paste0("row",1:K)
colnames(true_f) <- paste0("column",1:n)

rownames(estimated_f) <- paste0("row",1:K)
colnames(estimated_f) <- paste0("column",1:n)
